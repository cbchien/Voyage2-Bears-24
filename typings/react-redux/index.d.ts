...
type ComponentClass<P> = React.ComponentClass<any>;
type StatelessComponent<P> = React.StatelessComponent<any>;
type Component<P> = React.ComponentType<any>;
type ReactNode = React.ReactNode;
type Store<S> = Redux.Store<any>;
type Dispatch<S> = Redux.Dispatch<any>;
type ActionCreator<A> = Redux.ActionCreator<any>;
